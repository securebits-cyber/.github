...
```mermaid
flowchart TD
    CORE["Core — free & open source<br/>Phishing simulations · Training · Basic reporting<br/>Self-hosting · Community support"]
    BUSINESS["+ Business — tiered by employee count<br/>Multi-stage & recurring campaigns · Spear phishing / whaling / quishing<br/>Ready-made templates (DHL, banks, HR, QR) · LDAP / Azure AD / Entra ID<br/>Compliance reports (GDPR, NIS2, ISO 27001)"]
    ENTERPRISE["+ Enterprise — upgrade on Business (+40%)<br/>White-label · SAML SSO · SIEM export (Wazuh, Splunk, Sentinel)<br/>AI risk scoring · risk-based & automated campaigns"]
